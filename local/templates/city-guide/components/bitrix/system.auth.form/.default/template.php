...
<?endforeach?>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8  col-md-10">
            <input class="form-control" type="password" name="USER_PASSWORD" maxlength="50" size="17" autocomplete="off" />
    ...
    <div class="form-group row">
        <div class="col-sm-12">
            <input class="btn btn-default buttonLogin" type="submit" name="Login" value="<?=GetMessage("AUTH_LOGIN_BUTTON")?>" />
        </div>
    </div>
