            ...
            <div class="row">
                ...
                <div class="col-12 col-md-7">
                    ...
                    <div class="box-preview-text">
                        ...
                        ?>
                        <p><b>Автор:</b> <?= $arUser['NAME'] . ' ' . $arUser['LAST_NAME']; ?></p>
                    </div>

                </div>
                <div class="col-12 col-md-2">
                    <a href="/personal/my-tur/add.php?id=<?= $arItem['ID']; ?>" title="Изменить"
                       class="btn btn-primary btn-edit">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="/personal/my-tur/remove.php?id=<?= $arItem['ID']; ?>" title="Удалить"
