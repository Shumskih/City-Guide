...
if ($arResult["USE_CAPTCHA"] == "Y")
{
    ...
    <div class="form-group">
        <label class="col-sm-4"><?=GetMessage("REGISTER_CAPTCHA_TITLE")?></label>
        <div class="col-sm-8">
    ...
    <div class="form-group">
        <label class="col-sm-4"><?=GetMessage("REGISTER_CAPTCHA_PROMT")?>:<span class="starrequired">*</span></label>
        <div class="col-sm-8">
...
?>
    <div class="form-group">
        <div class="col-sm-12">
            <input class="btn btn-default buttonLogin" type="submit" name="register_submit_button" value="<?=GetMessage("AUTH_REGISTER")?>" />
        </div>
    </div>
